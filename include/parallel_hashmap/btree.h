...
#define PHMAP_COMPARE_INLINE_INIT(type, name, init) \
    ...
    public:
        ...
        // Comparisons
        constexpr friend bool operator==(partial_ordering v, compare_internal::OnlyLiteralZero<>) noexcept
        {
        ...
        constexpr friend bool operator==(compare_internal::OnlyLiteralZero<>, partial_ordering v) noexcept
        {
...
namespace phmap
{
    ...
    namespace priv
    {
        ...
        struct StringBtreeDefaultLess
        {
            ...
            {} // NOLINT
#if PHMAP_HAVE_STD_STRING_VIEW
            StringBtreeDefaultLess(std::less<std::string_view>)
            {} // NOLINT

            StringBtreeDefaultLess(phmap::Less<std::string_view>)
            {} // NOLINT
...
#pragma GCC diagnostic pop
        ...
        public:
            ...
            iterator insert(const_iterator hint, node_type&& node)
            {
                ...
                std::pair<iterator, bool> res =
                    this->tree_.insert_hint_unique(iterator(hint), params_type::key(CommonAccess::GetSlot(node)), CommonAccess::GetSlot(node));
                if (res.second)
                    CommonAccess::Destroy(&node);
                return res.first;
            }
            ...
            template <
                ...
                typename phmap::enable_if_t<
                    phmap::conjunction<std::is_same<value_type, typename T::value_type>, std::is_same<allocator_type, typename T::allocator_type>,
    ...
    class btree_multiset
        : public priv::btree_multiset_container<priv::btree<priv::set_params<Key, Compare, Alloc, /*TargetNodeSize=*/256, /*Multi=*/true>>>
    {
    ...
    class btree_map
        : public priv::btree_map_container<priv::btree<priv::map_params<Key, Value, Compare, Alloc, /*TargetNodeSize=*/256, /*Multi=*/false>>>
    {
    ...
    class btree_multimap
        : public priv::btree_multimap_container<priv::btree<priv::map_params<Key, Value, Compare, Alloc, /*TargetNodeSize=*/256, /*Multi=*/true>>>
    {
