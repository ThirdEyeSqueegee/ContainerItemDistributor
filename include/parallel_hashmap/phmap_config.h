...
#if (!defined(__GNUC__) || defined(__clang__) || __GNUC__ >= 5) && ((defined(_MSVC_LANG) && _MSVC_LANG >= 201703L) || __cplusplus >= 201703L)
...
#elif defined(__linux__) || defined(__APPLE__) || defined(__FreeBSD__) || defined(__ros__) || defined(__native_client__) || defined(__asmjs__) \
    || defined(__wasm__) || defined(__Fuchsia__) || defined(__sun) || defined(__ASYLO__)
