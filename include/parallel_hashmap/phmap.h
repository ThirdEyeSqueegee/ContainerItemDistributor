...
namespace phmap
{
    ...
    namespace priv
    {
        ...
        struct IsDecomposable<phmap::void_t<decltype(Policy::apply(RequireUsableKey<typename Policy::key_type, Hash, Eq>(), std::declval<Ts>()...))>,
...
#pragma warning(pop)
        ...
        namespace memory_internal
        {
            ...
            template <class T>
            auto TupleRef(T&& t)
                -> decltype(TupleRefImpl(std::forward<T>(t), phmap::make_index_sequence<std::tuple_size<typename std::decay<T>::type>::value>()))
            {
      ...
      // PRECONDITION: not a begin() iterator.
        ...
        iterator operator--(int) {
            ...
            raw_hash_set(raw_hash_set&& that) noexcept(
                ...
                : ctrl_(phmap::exchange(that.ctrl_, EmptyGroup())), slots_(phmap::exchange(that.slots_, nullptr)),
                  size_(phmap::exchange(that.size_, 0)), capacity_(phmap::exchange(that.capacity_, 0)),
        ...
        private:
            ...
            void erase_meta_only(const_iterator it)
            {
                ...
                bool was_never_full =
                    empty_before && empty_after && static_cast<size_t>(empty_after.TrailingZeros() + empty_before.LeadingZeros()) < Group::kWidth;
        ...
        decltype(std::declval<F>()(std::declval<T>())) WithConstructed(Tuple&& t, F&& f)
        {
            return memory_internal::WithConstructedImpl<T>(
                std::forward<Tuple>(t), phmap::make_index_sequence<std::tuple_size<typename std::decay<Tuple>::type>::value>(), std::forward<F>(f));
        }
    ...
    class parallel_flat_hash_set
        : public phmap::priv::parallel_hash_set<N, phmap::priv::raw_hash_set, Mtx_, phmap::priv::FlatHashSetPolicy<T>, Hash, Eq, Alloc>
    {
    ...
    class parallel_flat_hash_map
        : public phmap::priv::parallel_hash_map<N, phmap::priv::raw_hash_set, Mtx_, phmap::priv::FlatHashMapPolicy<K, V>, Hash, Eq, Alloc>
    {
    ...
    class parallel_node_hash_set
        : public phmap::priv::parallel_hash_set<N, phmap::priv::raw_hash_set, Mtx_, phmap::priv::NodeHashSetPolicy<T>, Hash, Eq, Alloc>
    {
    ...
    class parallel_node_hash_map
        : public phmap::priv::parallel_hash_map<N, phmap::priv::raw_hash_set, Mtx_, phmap::priv::NodeHashMapPolicy<Key, Value>, Hash, Eq, Alloc>
    {
