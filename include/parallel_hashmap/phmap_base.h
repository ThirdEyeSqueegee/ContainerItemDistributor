...
#define PHMAP_OLD_GCC 0
    ...
    struct is_trivially_copy_constructible
        : std::integral_constant<bool, __has_trivial_copy(typename std::remove_reference<T>::type) && std::is_copy_constructible<T>::value
...
#define PHMAP_META_INTERNAL_STD_HASH_SFINAE_FRIENDLY_ 1
        ...
        struct IsHashable<
            Key, phmap::enable_if_t<std::is_convertible<decltype(std::declval<std::hash<Key>&>()(std::declval<const Key&>())), std::size_t>::value>>
            : std::true_type
        {};
#endif
...
namespace phmap
{
    ...
    struct allocator_traits
    {
        ...
        using void_pointer =
            memory_internal::ExtractOrT<memory_internal::GetVoidPointer, Alloc, typename phmap::pointer_traits<pointer>::template rebind<void>>;
        ...
        using difference_type =
            memory_internal::ExtractOrT<memory_internal::GetDifferenceType, Alloc, typename phmap::pointer_traits<pointer>::difference_type>;
...
#endif
#elif (defined(__GNUC__) && (__GNUC__ > 4 || __GNUC__ == 4 && __GNUC_MINOR__ >= 8)) || (__cpp_inheriting_constructors >= 200802) \
...
namespace phmap
{
    ...
    namespace optional_internal
    {
        ...
        template <typename T, bool unused = phmap::is_trivially_copy_constructible<T>::value&& phmap::is_trivially_copy_assignable<
...
#define PHMAP_OPTIONAL_NOEXCEPT noexcept
    ...
    public:
        ...
        template <typename U,
                  typename std::enable_if<phmap::conjunction<phmap::negation<std::is_same<T, U>>, std::is_constructible<T, const U&>,
        ...
        template <typename U = T, typename = typename std::enable_if<phmap::conjunction<
                                      phmap::negation<std::is_same<optional<T>, typename std::decay<U>::type>>,
        ...
        template <typename U, typename = typename std::enable_if<phmap::conjunction<
...
namespace phmap
{
    ...
    public:
        ...
        public:
            ...
            WriteLocks(adopt_lock_t, mutex_type& m1, mutex_type& m2) : _m1(m1), _m2(m2)
        ...
        public:
            ...
            ReadLocks(adopt_lock_t, mutex_type& m1, mutex_type& m2) : _m1(m1), _m2(m2)
            { // adopt means we already own the mutexes
            }
