...
#define PHMAP_OLD_GCC 0
    ...
    template <typename T>
    struct is_trivially_copy_assignable : std::integral_constant<bool, __has_trivial_assign(typename std::remove_reference<T>::type) && phmap::is_copy_assignable<T>::value>
    {
    };
        ...
        namespace internal_layout
        {
            ...
            public:
                ...
                CopyConst<Char, ElementType<N>>* Pointer(Char* p) const
                {
                    ...
                    static_assert(std::is_same<C, char>() || std::is_same<C, unsigned char>() || std::is_same<C, signed char>(), "The argument must be a "
                                                                                                                                 "pointer to [const] "
